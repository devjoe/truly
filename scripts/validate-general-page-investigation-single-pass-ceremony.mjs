...
} from "./lib/general-page-investigation-single-pass-ceremony.mjs";
...
const artifact = {
  ...validateSinglePassInvestigationCeremony(receipts, candidateCommit),
...
console.log(JSON.stringify({
  ...
  formatCounts: artifact.formatCounts,
  serviceProfiles: artifact.serviceProfiles,
