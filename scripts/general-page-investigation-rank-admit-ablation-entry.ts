...
const fixtures: Fixture[] = [
  ...
  { sampleId: "rank-admit-zh-specific-over-overview", language: "zh-TW", kind: "admission-sensitive", title: "雲端儲存介面限制", groundingText: "雲端儲存 API 可讓擴充功能儲存應用程式資料。北港瀏覽器公司公告每個同步儲存項目的上限為 8 KB。開發者可在不同裝置讀取資料。", expectedExactText: "北港瀏覽器公司公告每個同步儲存項目的上限為 8 KB" },
  { sampleId: "rank-admit-en-specific-over-overview", language: "en", kind: "admission-sensitive", title: "Cloud storage API limits", groundingText: "The cloud storage API lets extensions save application data. Northbridge Browser Company caps each synchronized storage item at 8 KB. Developers can read the data on different devices.", expectedExactText: "Northbridge Browser Company caps each synchronized storage item at 8 KB" },
  { sampleId: "rank-admit-zh-unnamed-analysis-abstain", language: "zh-TW", kind: "admission-sensitive", title: "新產品市場觀察", groundingText: "分析人士認為這項未命名產品可能重塑市場，但文章沒有指出分析人士姓名、研究機構、產品規格或發布日期。", expectedExactText: null },
  { sampleId: "rank-admit-en-unnamed-analysis-abstain", language: "en", kind: "admission-sensitive", title: "An unnamed product outlook", groundingText: "Analysts believe the unnamed product could reshape the market, but the article gives no analyst, research firm, product specification, or release date.", expectedExactText: null },
