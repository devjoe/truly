...
const REQUIRED_SNIPPETS = [
  {
    ...
    snippets: [
      ...
      "tracks\n  `origin/codex/general-page-reader-contract`",
      "`v0.1.2-preview.12` to exist locally and point at HEAD",
      "dashboard state for the earlier `0.1.1 Preview 9` submission",
