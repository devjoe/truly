/* @ts-self-types="./zhtw_mcp_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function scan_text(text, options_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.scan_text(retptr, ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zhtw_mcp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
