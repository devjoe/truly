...
export function buildGeneralPageInvestigationSpanAdapterSystemPrompt(): string {
  return [
    ...
    "Reject navigation or interface text, headings, citations, incidental catalog metadata, image credits, and related-content or link-preview text.",
    ...
    "For reference or tutorial material, prefer a concrete version or compatibility boundary, limit, unsupported capability, measurable behavior, security consequence, descriptive public record, or external event over a basic definition, feature overview, example, ordinary workflow, preference, or generic recommendation.",
