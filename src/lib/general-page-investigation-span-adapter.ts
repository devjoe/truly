...
export function buildGeneralPageInvestigationSpanAdapterSystemPrompt(): string {
  return [
    ...
    "Reject fragments, cut-off text, unresolved referents, instructions, private anecdotes, subjective opinions or rankings, recommendations, predictions, unnamed hearsay, and vague claims attributed only to unspecified research or experts. On a course, guide, or advice Page, reject generalized social or behavioral viewpoints such as what people regard as useful or what makes sense unless the same exact span attributes a concrete externally checkable finding to a named source; declarative grammar alone does not make advice factual. On a philosophical, theological, ideological, or literary-argument Page, reject the author's abstract assertions, worldview comparisons, value judgments, and claims about what authority, reason, experience, morality, or belief implies. A proposition being debatable does not make it publicly verifiable; only a separate exact span reporting a named real-world event, measurement, document record, or attributed public statement may survive. On a first-person letter, diary, or memoir Page, reject the narrator's own movements, encounters, experiences, recollections, and reported reactions even when names, dates, or places are specific; public archiving does not turn private narrative into a reader verification action. Reject tutorial, course, or book promises about what the reader will learn or be able to do after completing the material.",
    "Reject navigation or interface text, headings, captions, bylines, credits, citations, publisher labels, code or API-member labels, table labels, update-log labels, related-content text, and license or download boilerplate. Reject any span that flattens one of those Page roles into body prose.",
    ...
    "Use exploratory for a complete publicly checkable stable definition, API behavior, workflow, capability, historical record, catalog fact, or ordinary situational detail. Stable instructions, policies, reference documentation, API capabilities, catalogs, and historical records are exploratory, never primary, unless the Page explicitly presents that exact proposition as a current change or event. Before returning JSON, apply a final Page-role tier check: stable documentation, reference, history, or biography can only be exploratory unless the same Page explicitly presents the exact span as a current change, launch, incident, decision, measurement, deadline, or availability change. A name, date, number, supported format, official publisher, or syntactically strong sentence does not by itself make the action primary and never overrides this Page-role check.",
...
export function buildGeneralPageInvestigationSpanAdapterPrompt(
  ...
  return [
    ...
    "Final veto: when the Page purpose is selling a subscription, membership, or upgrade, omit claims that merely describe its benefits or locked features. On a course, guide, advice, or opinion Page, omit generalized views about what groups regard as useful, important, or sensible unless the exact span attributes a concrete externally checkable finding to a named source. On a philosophical, theological, ideological, or literary-argument Page, omit the author's abstract assertions, worldview comparisons, value judgments, and claims about what authority, reason, experience, morality, or belief implies; debatable prose is not automatically publicly verifiable. On a first-person letter, diary, memoir, or testimony Page, omit the narrator's own movements, encounters, experiences, recollections, and reported reactions; names, dates, places, and public archiving do not rescue them. When the Page is fiction, satire, parody, a fan wiki, or a fictional character, spell, item, plot, or story reference, omit story-world events and dialogue even when they imitate news, quote named sources, or use real organizations. When the authorized context is only an update history, publication log, or 'Updates to this page' list, omit every entry as publisher metadata. On a literary Page, omit notes or commentary that only explain its characters, plot, dialogue, or translation. Omit publisher or license boilerplate. If the Page role is unclear and a candidate matches one of these classes, omit it. Use an empty selections array when none qualifies.",
