...
export function buildGeneralPageInvestigationSpanAdapterPrompt(
  ...
  return [
    ...
    "Final veto: when the Page purpose is selling a subscription, membership, or upgrade, omit claims that merely describe its benefits or locked features. Omit fictional narration and publisher or license boilerplate. Use an empty selections array when none qualifies.",
