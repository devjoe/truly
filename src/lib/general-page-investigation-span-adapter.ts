...
export function buildGeneralPageInvestigationSpanAdapterSystemPrompt(): string {
  return [
    ...
    "Do not use attribution as a loophole: reject an unnamed person's vague claim and an organizer's promotional superlative even though public evidence could show that the words were said.",
