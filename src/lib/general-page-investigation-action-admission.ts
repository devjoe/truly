...
export function buildGeneralPageInvestigationActionAdmissionSystemPrompt(): string {
  return [
    ...
    "1. The exact selected text is a complete standalone proposition, not a fragment, bare label, name, publisher, credit, identifier, or name-plus-date string. A coherent primary-record span may include an identifier and structured labels when it also identifies the item or work and states a specific record fact.",
    "2. It states a concrete external-world fact that independent public evidence can decide, such as an event, action, record, measurement, product availability, menu change, compatibility constraint, permission, security boundary, or versioned behavior. Literal checkability is not enough: the proposition must give a reasonable reader something more useful to investigate than simply continuing to read an ordinary reference or tutorial page.",
    ...
    "4. It is not incidental page, release, publication, copyright, download-count, availability-utility, or catalog metadata attached to a different substantive page.",
    "5. In real-world reference material it may be a named public system, scientific or health fact, official measurement, or dataset or record statistic. In software, API, language, or developer documentation it must be a specific compatibility or security consequence, versioned limit, breaking change, or time-sensitive product fact—not a basic definition, correct API behavior, capability overview, example, tutorial step, or ordinary workflow.",
    "Reject a proposition whose content is only a personal feeling, intention, preference, memory, private relationship detail, or anecdote; an attributed opinion, prediction, recommendation, subjective ranking, slogan, insult, or inflammatory metaphor; a vague trend or broad interpretation; a generic definition, feature overview, tutorial step, ordinary workflow, or routine developer-documentation fact; or incidental catalog or page metadata.",
    "Reject an anonymous anecdote generalized to a wider group. Reject a statistic or trend attributed only to vague 'research', 'studies', or 'experts' when the exact sentence identifies no study, organization, dataset, or other realistically locatable public evidence.",
    ...
    "For example, reject \"Reviewer Lin said Far Shore was the best film of the year\": verifying that the words were spoken does not make the underlying subjective ranking a useful first verification action.",
    "Likewise, reject a quote whose only payload is a slogan, insult, or metaphor; admit the attribution only when the same exact sentence states a concrete public action, policy, event, number, or record.",
    "Do not reject a concrete public record, event, or attributed public statement merely because it concerns biography, relationships, entertainment, or celebrity.",
    ...
    "Example to admit on the matching book-record page: \"123456 Title The North Wind Original Publication London: Harbor Press, 1923\". Reject a bare record field such as only \"Original Publication ... 1950\", an ID-only string, release or download metadata, or a fragment such as \"Lippincott Company, 1900\".",
    "Reject a trailing where-to-watch, where-to-buy, rental, subscription, download, or source-availability list when it is publisher utility attached to another article. A product-availability fact central to the page may still pass.",
    "Reject flattened reference text that mixes headings, version badges, permission labels, or interface words into a broken sentence, even when some tokens are factual.",
    "Reject a span that begins with an article title, section heading, publisher label, or media credit flattened into an otherwise factual sentence.",
    "Reject a metaphor, nickname, analogy, or cultural allusion whose factual meaning depends on the following explanation rather than the exact selected text.",
    "Reject speculative inference signaled by wording such as 'so ... must have', 'apparently', or an equivalent leap from one fact to an unstated conclusion.",
