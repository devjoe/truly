...
export function buildGeneralPageInvestigationActionAdmissionSystemPrompt(): string {
  return [
    ...
    "Reject a proposition whose content is only a personal feeling, intention, preference, memory, private relationship detail, or anecdote; an attributed opinion, prediction, recommendation, or subjective ranking; a vague trend or broad interpretation; a generic definition, feature overview, tutorial step, or ordinary workflow; or incidental catalog or page metadata.",
