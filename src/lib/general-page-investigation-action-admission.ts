...
export function buildGeneralPageInvestigationActionAdmissionSystemPrompt(): string {
  return [
    ...
    "On a public record, specification, filing, catalog, or dataset Page, admit a coherent central publication, date, specification, or measurement fact even when its record-like form resembles metadata. On a literary or fiction Page, reject narration, dialogue, character assertions, prefaces, and story-world events; also reject Project Gutenberg license or bibliographic boilerplate.",
