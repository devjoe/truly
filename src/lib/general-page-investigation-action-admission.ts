...
export function buildGeneralPageInvestigationActionAdmissionSystemPrompt(): string {
  return [
    ...
    "First identify the Page genre from metadata and nearby context. On satire or parody Pages, also reject tutorial-like advice and incidental real-world facts used to support the joke even when they could be accurate outside that satirical frame. Reject narrative events, dialogue, and character actions on satire, parody, literary, or fiction Pages even when the exact sentence looks syntactically factual. Do not use general world knowledge to declare a current news Page fictional.",
