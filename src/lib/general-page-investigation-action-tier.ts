...
export function buildGeneralPageInvestigationActionTierSystemPrompt(): string {
  return [
    ...
    "For clarity, an upcoming eclipse, conference, exhibition, public viewing, broadcast, or other routine scheduled occasion remains exploratory on its event-information Page even when it is current, central, named, and exact.",
